...
@Singleton
public class TelegramAzureChatBot extends ChatBotsTelegram implements AzureCloudFeature, AzureMicronautRuntimeFeature, OpenRewriteFeature {
    ...
    public List<String> getRecipes(GeneratorContext generatorContext) {
        return List.of("io.micronaut.starter.feature.chatbots-telegram-azure-function");
    }
