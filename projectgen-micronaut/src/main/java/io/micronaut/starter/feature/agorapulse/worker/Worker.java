...
import io.micronaut.projectgen.micronaut.template.agorapulse.worker.emailDigestDistributedJobGroovy;
import io.micronaut.projectgen.micronaut.template.agorapulse.worker.emailDigestDistributedJobJava;
import io.micronaut.projectgen.micronaut.template.agorapulse.worker.emailDigestDistributedJobKotlin;
import io.micronaut.projectgen.micronaut.template.agorapulse.worker.emailDigestDistributedJobSpecGroovy;
import io.micronaut.projectgen.micronaut.template.agorapulse.worker.emailDigestDistributedJobTestJava;
import io.micronaut.projectgen.micronaut.template.agorapulse.worker.emailDigestDistributedJobTestKotest;
import io.micronaut.projectgen.micronaut.template.agorapulse.worker.emailDigestDistributedJobTestKotlin;
import io.micronaut.projectgen.micronaut.template.agorapulse.worker.emailDigestServiceGroovy;
import io.micronaut.projectgen.micronaut.template.agorapulse.worker.emailDigestServiceJava;
import io.micronaut.projectgen.micronaut.template.agorapulse.worker.emailDigestServiceKotlin;
import io.micronaut.projectgen.micronaut.template.agorapulse.worker.emailDigestSimpleJobGroovy;
import io.micronaut.projectgen.micronaut.template.agorapulse.worker.emailDigestSimpleJobJava;
import io.micronaut.projectgen.micronaut.template.agorapulse.worker.emailDigestSimpleJobKotlin;
import io.micronaut.projectgen.micronaut.template.agorapulse.worker.emailDigestSimpleJobSpecGroovy;
import io.micronaut.projectgen.micronaut.template.agorapulse.worker.emailDigestSimpleJobTestJava;
import io.micronaut.projectgen.micronaut.template.agorapulse.worker.emailDigestSimpleJobTestKotest;
import io.micronaut.projectgen.micronaut.template.agorapulse.worker.emailDigestSimpleJobTestKotlin;
