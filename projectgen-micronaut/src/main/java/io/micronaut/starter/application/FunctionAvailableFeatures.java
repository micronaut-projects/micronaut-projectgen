...
public class FunctionAvailableFeatures extends BaseAvailableFeatures {
    ...
    public FunctionAvailableFeatures(List<Feature> features) {
        super(features, f -> f.supports(GenericOptionsBuilder.builder().template(ApplicationType.FUNCTION.toString()).build()));
    }

    @Override
    public boolean supports(Options options) {
        return options.template().equals(ApplicationType.FUNCTION.toString());
    }
