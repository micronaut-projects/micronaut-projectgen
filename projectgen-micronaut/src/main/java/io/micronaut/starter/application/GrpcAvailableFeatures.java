...
public class GrpcAvailableFeatures extends BaseAvailableFeatures {
    ...
    public GrpcAvailableFeatures(List<Feature> features) {
        super(features, f -> f.supports(GenericOptionsBuilder.builder().template(ApplicationType.GRPC.toString()).build()));
    }

    @Override
    public boolean supports(Options options) {
        return options.template().equals(ApplicationType.GRPC.toString());
    }
