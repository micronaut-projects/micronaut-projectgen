 ...
 * Adds the necessary configuration and recipes for Bedrock language model support.
 */
...
@Singleton
public class BedrockLangchain4jLanguageModel implements Langchain4jLanguageModel, OpenRewriteFeature {
    ...
    public List<String> getRecipes(GeneratorContext generatorContext) {
        return List.of("io.micronaut.starter.feature.langchain4j-bedrock");
    }
}
