 ...
 */
@Singleton
public class MicronautAotGradlePlugin implements BuildPluginFeature, GradleSpecificFeature {
    private static final String AOT_GRADLE_PLUGIN_ID = "io.micronaut.aot";
    private static final int GRADLE_PLUGIN_ORDER = 10;

    @Override
    public String getName() {
        return "micronaut-aot-gradle-plugin";
    }
