...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/agorapulse/worker/emailDigestSimpleJobTestKotlin.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class emailDigestSimpleJobTestKotlin extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "emailDigestSimpleJobTestKotlin.rocker.raw"; }
    ...
    public emailDigestSimpleJobTestKotlin project(Project project) {
    ...
    static public emailDigestSimpleJobTestKotlin template(Project project) {
        return new emailDigestSimpleJobTestKotlin()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        // \n\nimport com.agorapulse.worker.JobManager\nimport io.micronaut.test.annotation.MockBean\nimport io.micronaut.test.extensions.junit5.annotation.MicronautTest\nimport jakarta.inject.Inject\nimport org.awaitility.Awaitility.await\nimport org.junit.jupiter.api.Test\nimport org.mockito.Mockito.*\nimport java.util.concurrent.TimeUnit\n\n@MicronautTest\ninternal class EmailDigestSimpleJobTest {\n\n    @Inject\n    lateinit var jobManager: JobManager\n\n    @Inject\n    lateinit var emailDigestServ...
        static private final byte[] PLAIN_TEXT_2_0;

        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(emailDigestSimpleJobTestKotlin.class.getClassLoader(), emailDigestSimpleJobTestKotlin.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(emailDigestSimpleJobTestKotlin model) {
            super(model);
