...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/server/javaController.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class javaController extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "javaController.rocker.raw"; }
    ...
    public javaController project(Project project) {
    ...
    static public javaController template(Project project) {
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(javaController.class.getClassLoader(), javaController.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(javaController model) {
            super(model);
        ...
        protected void __doRender() throws IOException, RenderingException {
            ...
            // ValueExpression @ [14:16]
            __internal.aboutToExecutePosInTemplate(14, 16);
