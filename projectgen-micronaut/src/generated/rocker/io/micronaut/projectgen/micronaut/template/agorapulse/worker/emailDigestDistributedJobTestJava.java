...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/agorapulse/worker/emailDigestDistributedJobTestJava.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class emailDigestDistributedJobTestJava extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "emailDigestDistributedJobTestJava.rocker.raw"; }
    ...
    public emailDigestDistributedJobTestJava project(Project project) {
    ...
    static public emailDigestDistributedJobTestJava template(Project project) {
        return new emailDigestDistributedJobTestJava()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(emailDigestDistributedJobTestJava.class.getClassLoader(), emailDigestDistributedJobTestJava.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(emailDigestDistributedJobTestJava model) {
            super(model);
