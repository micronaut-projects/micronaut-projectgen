...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/agorapulse/slack/messageSenderGroovy.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class messageSenderGroovy extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "messageSenderGroovy.rocker.raw"; }
    ...
    public messageSenderGroovy project(Project project) {
    ...
    static public messageSenderGroovy template(Project project) {
        return new messageSenderGroovy()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(messageSenderGroovy.class.getClassLoader(), messageSenderGroovy.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(messageSenderGroovy model) {
            super(model);
