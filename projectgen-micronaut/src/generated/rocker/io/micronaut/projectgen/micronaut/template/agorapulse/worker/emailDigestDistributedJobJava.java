...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/agorapulse/worker/emailDigestDistributedJobJava.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class emailDigestDistributedJobJava extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "emailDigestDistributedJobJava.rocker.raw"; }
    ...
    public emailDigestDistributedJobJava project(Project project) {
    ...
    static public emailDigestDistributedJobJava template(Project project) {
        return new emailDigestDistributedJobJava()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        public Template(emailDigestDistributedJobJava model) {
            super(model);
