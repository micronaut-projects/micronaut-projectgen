...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/agorapulse/worker/emailDigestSimpleJobTestJava.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class emailDigestSimpleJobTestJava extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "emailDigestSimpleJobTestJava.rocker.raw"; }
    ...
    public emailDigestSimpleJobTestJava project(Project project) {
    ...
    static public emailDigestSimpleJobTestJava template(Project project) {
        return new emailDigestSimpleJobTestJava()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(emailDigestSimpleJobTestJava.class.getClassLoader(), emailDigestSimpleJobTestJava.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(emailDigestSimpleJobTestJava model) {
            super(model);
