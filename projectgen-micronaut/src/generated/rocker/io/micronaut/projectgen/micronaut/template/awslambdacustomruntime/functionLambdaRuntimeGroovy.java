...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/awslambdacustomruntime/functionLambdaRuntimeGroovy.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class functionLambdaRuntimeGroovy extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "functionLambdaRuntimeGroovy.rocker.raw"; }
    ...
    public functionLambdaRuntimeGroovy features(Features features) {
    ...
    public functionLambdaRuntimeGroovy project(Project project) {
    ...
    static public functionLambdaRuntimeGroovy template(Features features, Project project) {
        return new functionLambdaRuntimeGroovy()
            .features(features)
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(functionLambdaRuntimeGroovy.class.getClassLoader(), functionLambdaRuntimeGroovy.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(functionLambdaRuntimeGroovy model) {
            super(model);
