...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/agorapulse/slack/messageSenderTestKotlin.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class messageSenderTestKotlin extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "messageSenderTestKotlin.rocker.raw"; }
    ...
    public messageSenderTestKotlin project(Project project) {
    ...
    static public messageSenderTestKotlin template(Project project) {
        return new messageSenderTestKotlin()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(messageSenderTestKotlin.class.getClassLoader(), messageSenderTestKotlin.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(messageSenderTestKotlin model) {
            super(model);
