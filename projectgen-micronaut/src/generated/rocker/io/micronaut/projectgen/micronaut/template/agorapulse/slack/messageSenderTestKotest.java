...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/agorapulse/slack/messageSenderTestKotest.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class messageSenderTestKotest extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "messageSenderTestKotest.rocker.raw"; }
    ...
    public messageSenderTestKotest project(Project project) {
    ...
    static public messageSenderTestKotest template(Project project) {
        return new messageSenderTestKotest()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(messageSenderTestKotest.class.getClassLoader(), messageSenderTestKotest.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(messageSenderTestKotest model) {
            super(model);
