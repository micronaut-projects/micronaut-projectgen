...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/chatbots/basecamp/aboutCommandHandlerJavaJunit.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class aboutCommandHandlerJavaJunit extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "aboutCommandHandlerJavaJunit.rocker.raw"; }
    ...
    public aboutCommandHandlerJavaJunit project(Project project) {
    ...
    static public aboutCommandHandlerJavaJunit template(Project project) {
        return new aboutCommandHandlerJavaJunit()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(aboutCommandHandlerJavaJunit.class.getClassLoader(), aboutCommandHandlerJavaJunit.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(aboutCommandHandlerJavaJunit model) {
            super(model);
