...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/awsalexa/cancelIntentHandlerGroovyJunit.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class cancelIntentHandlerGroovyJunit extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "cancelIntentHandlerGroovyJunit.rocker.raw"; }
    ...
    public cancelIntentHandlerGroovyJunit project(Project project) {
    ...
    static public cancelIntentHandlerGroovyJunit template(Project project) {
        return new cancelIntentHandlerGroovyJunit()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(cancelIntentHandlerGroovyJunit.class.getClassLoader(), cancelIntentHandlerGroovyJunit.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(cancelIntentHandlerGroovyJunit model) {
            super(model);
