...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/aws/ciawsconditionJava.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class ciawsconditionJava extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "ciawsconditionJava.rocker.raw"; }
    ...
    public ciawsconditionJava project(Project project) {
    ...
    static public ciawsconditionJava template(Project project) {
        return new ciawsconditionJava()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        public Template(ciawsconditionJava model) {
            super(model);
