...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/agorapulse/slack/reactionHandlerGruTestJava.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class reactionHandlerGruTestJava extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "reactionHandlerGruTestJava.rocker.raw"; }
    ...
    public reactionHandlerGruTestJava project(Project project) {
    ...
    static public reactionHandlerGruTestJava template(Project project) {
        return new reactionHandlerGruTestJava()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(reactionHandlerGruTestJava.class.getClassLoader(), reactionHandlerGruTestJava.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(reactionHandlerGruTestJava model) {
            super(model);
