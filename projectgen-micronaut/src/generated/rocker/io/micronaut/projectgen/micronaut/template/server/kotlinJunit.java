...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/server/kotlinJunit.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class kotlinJunit extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "kotlinJunit.rocker.raw"; }
    ...
    public kotlinJunit project(Project project) {
    ...
    public kotlinJunit transactional(boolean transactional) {
    ...
    static public kotlinJunit template(Project project, boolean transactional) {
        return new kotlinJunit()
            .project(project)
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        public Template(kotlinJunit model) {
            super(model);
        ...
        protected void __doRender() throws IOException, RenderingException {
            ...
            // ValueExpression @ [32:68]
            __internal.aboutToExecutePosInTemplate(32, 68);
            __internal.renderValue(project.getPropertyName(), false);
            // PlainText @ [32:94]
            __internal.aboutToExecutePosInTemplate(32, 94);
    ...
    private static class PlainText {
        ...
        static private final String PLAIN_TEXT_7_0 = "ControllerTest(private val embeddedServer: EmbeddedServer) {\n\n    @Test\n    fun testServerIsRunning() {\n        assert(embeddedServer.isRunning())\n    }\n\n    @Test\n    fun testIndex() {\n        val client: HttpClient = embeddedServer.applicationContext.createBean(HttpClient::class.java, embeddedServer.url)\n        assertEquals(HttpStatus.OK, client.toBlocking().exchange(\"/";
        static private final String PLAIN_TEXT_8_0 = "\", String::class.java).status())\n        client.close()\n    }\n}\n";
