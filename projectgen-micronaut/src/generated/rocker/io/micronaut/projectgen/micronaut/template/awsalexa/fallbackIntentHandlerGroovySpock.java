...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/awsalexa/fallbackIntentHandlerGroovySpock.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class fallbackIntentHandlerGroovySpock extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "fallbackIntentHandlerGroovySpock.rocker.raw"; }
    ...
    public fallbackIntentHandlerGroovySpock project(Project project) {
    ...
    static public fallbackIntentHandlerGroovySpock template(Project project) {
        return new fallbackIntentHandlerGroovySpock()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(fallbackIntentHandlerGroovySpock.class.getClassLoader(), fallbackIntentHandlerGroovySpock.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(fallbackIntentHandlerGroovySpock model) {
            super(model);
