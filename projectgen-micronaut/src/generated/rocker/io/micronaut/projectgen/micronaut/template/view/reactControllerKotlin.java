...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/view/reactControllerKotlin.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class reactControllerKotlin extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "reactControllerKotlin.rocker.raw"; }
    ...
    public reactControllerKotlin project(Project project) {
    ...
    static public reactControllerKotlin template(Project project) {
        return new reactControllerKotlin()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        // \n\nimport io.micronaut.core.annotation.Introspected\nimport io.micronaut.http.annotation.Controller\nimport io.micronaut.http.annotation.Get\nimport io.micronaut.http.HttpResponse\nimport io.micronaut.serde.annotation.Serdeable\nimport io.micronaut.views.View\n\nimport java.time.LocalDateTime\nimport java.time.format.DateTimeFormatter\nimport java.time.format.FormatStyle\n\n@Controller\npublic class AppController {\n    @Serdeable.Serializable\n    public data class CurrentTime(val now: Stri...
        static private final byte[] PLAIN_TEXT_3_0;

        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(reactControllerKotlin.class.getClassLoader(), reactControllerKotlin.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(reactControllerKotlin model) {
            super(model);
