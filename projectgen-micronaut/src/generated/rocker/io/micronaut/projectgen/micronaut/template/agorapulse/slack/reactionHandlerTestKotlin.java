...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/agorapulse/slack/reactionHandlerTestKotlin.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class reactionHandlerTestKotlin extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "reactionHandlerTestKotlin.rocker.raw"; }
    ...
    public reactionHandlerTestKotlin project(Project project) {
    ...
    static public reactionHandlerTestKotlin template(Project project) {
        return new reactionHandlerTestKotlin()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(reactionHandlerTestKotlin.class.getClassLoader(), reactionHandlerTestKotlin.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(reactionHandlerTestKotlin model) {
            super(model);
