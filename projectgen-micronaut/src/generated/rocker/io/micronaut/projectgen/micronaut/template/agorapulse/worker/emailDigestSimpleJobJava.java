...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/agorapulse/worker/emailDigestSimpleJobJava.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class emailDigestSimpleJobJava extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "emailDigestSimpleJobJava.rocker.raw"; }
    ...
    public emailDigestSimpleJobJava project(Project project) {
    ...
    static public emailDigestSimpleJobJava template(Project project) {
        return new emailDigestSimpleJobJava()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(emailDigestSimpleJobJava.class.getClassLoader(), emailDigestSimpleJobJava.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(emailDigestSimpleJobJava model) {
            super(model);
