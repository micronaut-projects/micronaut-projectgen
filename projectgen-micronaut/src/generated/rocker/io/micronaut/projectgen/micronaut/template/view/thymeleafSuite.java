...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/view/thymeleafSuite.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class thymeleafSuite extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "thymeleafSuite.rocker.raw"; }
    ...
    public thymeleafSuite project(Project project) {
    ...
    static public thymeleafSuite template(Project project) {
        return new thymeleafSuite()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(thymeleafSuite.class.getClassLoader(), thymeleafSuite.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(thymeleafSuite model) {
            super(model);
