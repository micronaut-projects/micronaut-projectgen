...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/awsalexa/sessionEndedRequestIntentHandlerKoTest.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class sessionEndedRequestIntentHandlerKoTest extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "sessionEndedRequestIntentHandlerKoTest.rocker.raw"; }
    ...
    public sessionEndedRequestIntentHandlerKoTest project(Project project) {
    ...
    static public sessionEndedRequestIntentHandlerKoTest template(Project project) {
        return new sessionEndedRequestIntentHandlerKoTest()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        // \n\nimport com.amazon.ask.dispatcher.request.handler.HandlerInput\nimport com.amazon.ask.model.RequestEnvelope\nimport com.amazon.ask.model.SessionEndedRequest\nimport io.kotest.core.spec.style.StringSpec\nimport io.kotest.matchers.booleans.shouldBeTrue\nimport io.micronaut.test.extensions.kotest5.annotation.MicronautTest\n\n@MicronautTest\nclass SessionEndedRequestIntentHandlerTest(private val handler: SessionEndedRequestIntentHandler): StringSpec({\n\n    \"testSessionEndedRequestIntentHand...
        static private final byte[] PLAIN_TEXT_3_0;

        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(sessionEndedRequestIntentHandlerKoTest.class.getClassLoader(), sessionEndedRequestIntentHandlerKoTest.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(sessionEndedRequestIntentHandlerKoTest model) {
            super(model);
