...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/server/kotlinController.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class kotlinController extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "kotlinController.rocker.raw"; }
    ...
    public kotlinController project(Project project) {
    ...
    static public kotlinController template(Project project) {
        return new kotlinController()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(kotlinController.class.getClassLoader(), kotlinController.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(kotlinController model) {
            super(model);
        ...
        protected void __doRender() throws IOException, RenderingException {
            ...
            // PlainText @ [16:42]
            __internal.aboutToExecutePosInTemplate(16, 42);
