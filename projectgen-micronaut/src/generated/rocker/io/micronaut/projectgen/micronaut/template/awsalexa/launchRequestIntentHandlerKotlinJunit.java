...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/awsalexa/launchRequestIntentHandlerKotlinJunit.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class launchRequestIntentHandlerKotlinJunit extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "launchRequestIntentHandlerKotlinJunit.rocker.raw"; }
    ...
    public launchRequestIntentHandlerKotlinJunit project(Project project) {
    ...
    static public launchRequestIntentHandlerKotlinJunit template(Project project) {
        return new launchRequestIntentHandlerKotlinJunit()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(launchRequestIntentHandlerKotlinJunit.class.getClassLoader(), launchRequestIntentHandlerKotlinJunit.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(launchRequestIntentHandlerKotlinJunit model) {
            super(model);
