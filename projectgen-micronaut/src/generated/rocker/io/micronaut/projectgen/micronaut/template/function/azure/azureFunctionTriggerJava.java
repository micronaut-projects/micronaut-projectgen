...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/function/azure/azureFunctionTriggerJava.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class azureFunctionTriggerJava extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "azureFunctionTriggerJava.rocker.raw"; }
    ...
    public azureFunctionTriggerJava project(Project project) {
    ...
    static public azureFunctionTriggerJava template(Project project) {
        return new azureFunctionTriggerJava()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(azureFunctionTriggerJava.class.getClassLoader(), azureFunctionTriggerJava.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(azureFunctionTriggerJava model) {
            super(model);
