...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/function/oraclefunction/raw/oracleRawFunctionJava.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class oracleRawFunctionJava extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "oracleRawFunctionJava.rocker.raw"; }
    ...
    public oracleRawFunctionJava project(Project project) {
    ...
    static public oracleRawFunctionJava template(Project project) {
        return new oracleRawFunctionJava()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(oracleRawFunctionJava.class.getClassLoader(), oracleRawFunctionJava.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(oracleRawFunctionJava model) {
            super(model);
