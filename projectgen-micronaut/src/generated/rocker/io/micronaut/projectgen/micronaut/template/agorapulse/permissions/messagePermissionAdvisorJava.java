...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/agorapulse/permissions/messagePermissionAdvisorJava.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class messagePermissionAdvisorJava extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "messagePermissionAdvisorJava.rocker.raw"; }
    ...
    public messagePermissionAdvisorJava project(Project project) {
    ...
    static public messagePermissionAdvisorJava template(Project project) {
        return new messagePermissionAdvisorJava()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(messagePermissionAdvisorJava.class.getClassLoader(), messagePermissionAdvisorJava.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(messagePermissionAdvisorJava model) {
            super(model);
