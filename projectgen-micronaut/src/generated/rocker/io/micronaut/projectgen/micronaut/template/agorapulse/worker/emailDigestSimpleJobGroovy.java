...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/agorapulse/worker/emailDigestSimpleJobGroovy.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class emailDigestSimpleJobGroovy extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "emailDigestSimpleJobGroovy.rocker.raw"; }
    ...
    public emailDigestSimpleJobGroovy project(Project project) {
    ...
    static public emailDigestSimpleJobGroovy template(Project project) {
        return new emailDigestSimpleJobGroovy()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(emailDigestSimpleJobGroovy.class.getClassLoader(), emailDigestSimpleJobGroovy.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(emailDigestSimpleJobGroovy model) {
            super(model);
