...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/chatbots/basecamp/aboutCommandHandlerGroovyJunit.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class aboutCommandHandlerGroovyJunit extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "aboutCommandHandlerGroovyJunit.rocker.raw"; }
    ...
    public aboutCommandHandlerGroovyJunit project(Project project) {
    ...
    static public aboutCommandHandlerGroovyJunit template(Project project) {
        return new aboutCommandHandlerGroovyJunit()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(aboutCommandHandlerGroovyJunit.class.getClassLoader(), aboutCommandHandlerGroovyJunit.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(aboutCommandHandlerGroovyJunit model) {
            super(model);
