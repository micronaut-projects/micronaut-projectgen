...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/agorapulse/slack/reactionHandlerTestJava.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class reactionHandlerTestJava extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "reactionHandlerTestJava.rocker.raw"; }
    ...
    public reactionHandlerTestJava project(Project project) {
    ...
    static public reactionHandlerTestJava template(Project project) {
        return new reactionHandlerTestJava()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(reactionHandlerTestJava.class.getClassLoader(), reactionHandlerTestJava.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(reactionHandlerTestJava model) {
            super(model);
