...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/agorapulse/permissions/messagePermissionAdvisorKotlin.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class messagePermissionAdvisorKotlin extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "messagePermissionAdvisorKotlin.rocker.raw"; }
    ...
    public messagePermissionAdvisorKotlin project(Project project) {
    ...
    static public messagePermissionAdvisorKotlin template(Project project) {
        return new messagePermissionAdvisorKotlin()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(messagePermissionAdvisorKotlin.class.getClassLoader(), messagePermissionAdvisorKotlin.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(messagePermissionAdvisorKotlin model) {
            super(model);
