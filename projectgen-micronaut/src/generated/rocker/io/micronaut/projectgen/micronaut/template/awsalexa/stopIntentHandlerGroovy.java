...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/awsalexa/stopIntentHandlerGroovy.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class stopIntentHandlerGroovy extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "stopIntentHandlerGroovy.rocker.raw"; }
    ...
    public stopIntentHandlerGroovy project(Project project) {
    ...
    static public stopIntentHandlerGroovy template(Project project) {
        return new stopIntentHandlerGroovy()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(stopIntentHandlerGroovy.class.getClassLoader(), stopIntentHandlerGroovy.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(stopIntentHandlerGroovy model) {
            super(model);
