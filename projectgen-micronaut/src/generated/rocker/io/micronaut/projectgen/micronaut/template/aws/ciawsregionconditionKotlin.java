...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/aws/ciawsregionconditionKotlin.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class ciawsregionconditionKotlin extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "ciawsregionconditionKotlin.rocker.raw"; }
    ...
    public ciawsregionconditionKotlin project(Project project) {
    ...
    static public ciawsregionconditionKotlin template(Project project) {
        return new ciawsregionconditionKotlin()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(ciawsregionconditionKotlin.class.getClassLoader(), ciawsregionconditionKotlin.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(ciawsregionconditionKotlin model) {
            super(model);
