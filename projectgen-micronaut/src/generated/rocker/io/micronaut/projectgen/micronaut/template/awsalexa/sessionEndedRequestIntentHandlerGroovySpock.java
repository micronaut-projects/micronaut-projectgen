...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/awsalexa/sessionEndedRequestIntentHandlerGroovySpock.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class sessionEndedRequestIntentHandlerGroovySpock extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "sessionEndedRequestIntentHandlerGroovySpock.rocker.raw"; }
    ...
    public sessionEndedRequestIntentHandlerGroovySpock project(Project project) {
    ...
    static public sessionEndedRequestIntentHandlerGroovySpock template(Project project) {
        return new sessionEndedRequestIntentHandlerGroovySpock()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(sessionEndedRequestIntentHandlerGroovySpock.class.getClassLoader(), sessionEndedRequestIntentHandlerGroovySpock.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(sessionEndedRequestIntentHandlerGroovySpock model) {
            super(model);
