...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/kotlin/homeRouteKotlin.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class homeRouteKotlin extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "homeRouteKotlin.rocker.raw"; }
    ...
    public homeRouteKotlin project(Project project) {
    ...
    static public homeRouteKotlin template(Project project) {
        return new homeRouteKotlin()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(homeRouteKotlin.class.getClassLoader(), homeRouteKotlin.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(homeRouteKotlin model) {
            super(model);
