...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/kafka/exampleFactoryKotlin.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class exampleFactoryKotlin extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "exampleFactoryKotlin.rocker.raw"; }
    ...
    public exampleFactoryKotlin project(Project project) {
    ...
    static public exampleFactoryKotlin template(Project project) {
        return new exampleFactoryKotlin()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(exampleFactoryKotlin.class.getClassLoader(), exampleFactoryKotlin.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(exampleFactoryKotlin model) {
            super(model);
