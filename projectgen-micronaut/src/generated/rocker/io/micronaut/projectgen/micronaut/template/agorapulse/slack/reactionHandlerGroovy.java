...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/agorapulse/slack/reactionHandlerGroovy.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class reactionHandlerGroovy extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "reactionHandlerGroovy.rocker.raw"; }
    ...
    public reactionHandlerGroovy project(Project project) {
    ...
    static public reactionHandlerGroovy template(Project project) {
        return new reactionHandlerGroovy()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        // \n\nimport com.agorapulse.slack.handlers.MicronautBoltEventHandler\nimport com.slack.api.app_backend.events.payload.EventsApiPayload\nimport com.slack.api.bolt.context.builtin.EventContext\nimport com.slack.api.bolt.response.Response\nimport com.slack.api.methods.MethodsClient\nimport com.slack.api.methods.SlackApiException\nimport com.slack.api.methods.request.chat.ChatPostMessageRequest.ChatPostMessageRequestBuilder\nimport com.slack.api.model.event.ReactionAddedEvent\nimport groovy.transfo...
        static private final byte[] PLAIN_TEXT_3_0;

        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(reactionHandlerGroovy.class.getClassLoader(), reactionHandlerGroovy.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(reactionHandlerGroovy model) {
            super(model);
