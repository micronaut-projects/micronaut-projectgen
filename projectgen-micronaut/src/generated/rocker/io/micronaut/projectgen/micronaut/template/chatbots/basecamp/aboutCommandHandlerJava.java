...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/chatbots/basecamp/aboutCommandHandlerJava.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class aboutCommandHandlerJava extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "aboutCommandHandlerJava.rocker.raw"; }
    ...
    public aboutCommandHandlerJava project(Project project) {
    ...
    static public aboutCommandHandlerJava template(Project project) {
        return new aboutCommandHandlerJava()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(aboutCommandHandlerJava.class.getClassLoader(), aboutCommandHandlerJava.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(aboutCommandHandlerJava model) {
            super(model);
