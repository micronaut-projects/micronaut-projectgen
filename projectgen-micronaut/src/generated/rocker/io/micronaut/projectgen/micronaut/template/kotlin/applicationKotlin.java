...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/kotlin/applicationKotlin.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class applicationKotlin extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "applicationKotlin.rocker.raw"; }
    ...
    public applicationKotlin project(Project project) {
    ...
    static public applicationKotlin template(Project project) {
        return new applicationKotlin()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(applicationKotlin.class.getClassLoader(), applicationKotlin.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(applicationKotlin model) {
            super(model);
