...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/aws/ciawsregionconditionJava.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class ciawsregionconditionJava extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "ciawsregionconditionJava.rocker.raw"; }
    ...
    public ciawsregionconditionJava project(Project project) {
    ...
    static public ciawsregionconditionJava template(Project project) {
        return new ciawsregionconditionJava()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        // ;\n\nimport io.micronaut.context.condition.Condition;\nimport io.micronaut.context.condition.ConditionContext;\nimport org.slf4j.Logger;\nimport org.slf4j.LoggerFactory;\nimport java.io.File;\n\n/**\n * @see <a href=\"https://docs.aws.amazon.com/sdk-for-java/latest/developer-guide/region-selection.html\">Default region provider chain</a>\n */\npublic class CIAwsRegionProviderChainCondition implements Condition {\n    private static final Logger LOG = LoggerFactory.getLogger(CIAwsRegionProvide...
        static private final byte[] PLAIN_TEXT_1_0;

        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(ciawsregionconditionJava.class.getClassLoader(), ciawsregionconditionJava.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(ciawsregionconditionJava model) {
            super(model);
