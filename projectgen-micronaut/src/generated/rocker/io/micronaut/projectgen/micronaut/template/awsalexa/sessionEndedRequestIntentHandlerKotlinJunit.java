...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/awsalexa/sessionEndedRequestIntentHandlerKotlinJunit.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class sessionEndedRequestIntentHandlerKotlinJunit extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "sessionEndedRequestIntentHandlerKotlinJunit.rocker.raw"; }
    ...
    public sessionEndedRequestIntentHandlerKotlinJunit project(Project project) {
    ...
    static public sessionEndedRequestIntentHandlerKotlinJunit template(Project project) {
        return new sessionEndedRequestIntentHandlerKotlinJunit()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(sessionEndedRequestIntentHandlerKotlinJunit.class.getClassLoader(), sessionEndedRequestIntentHandlerKotlinJunit.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(sessionEndedRequestIntentHandlerKotlinJunit model) {
            super(model);
