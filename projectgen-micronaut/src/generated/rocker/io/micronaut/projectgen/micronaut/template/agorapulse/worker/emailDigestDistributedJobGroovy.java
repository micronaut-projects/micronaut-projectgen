...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/agorapulse/worker/emailDigestDistributedJobGroovy.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class emailDigestDistributedJobGroovy extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "emailDigestDistributedJobGroovy.rocker.raw"; }
    ...
    public emailDigestDistributedJobGroovy project(Project project) {
    ...
    static public emailDigestDistributedJobGroovy template(Project project) {
        return new emailDigestDistributedJobGroovy()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        public Template(emailDigestDistributedJobGroovy model) {
            super(model);
