...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/awsalexa/cancelIntentHandlerKoTest.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class cancelIntentHandlerKoTest extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "cancelIntentHandlerKoTest.rocker.raw"; }
    ...
    public cancelIntentHandlerKoTest project(Project project) {
    ...
    static public cancelIntentHandlerKoTest template(Project project) {
        return new cancelIntentHandlerKoTest()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(cancelIntentHandlerKoTest.class.getClassLoader(), cancelIntentHandlerKoTest.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(cancelIntentHandlerKoTest model) {
            super(model);
