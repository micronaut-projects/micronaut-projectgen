...
/*
 * Auto generated code to render template io/micronaut/projectgen/micronaut/template/agorapulse/slack/commandHandlerJava.rocker.raw
 * Do not edit this file. Changes will eventually be overwritten by Rocker parser!
 */
@SuppressWarnings("unused")
public class commandHandlerJava extends com.fizzed.rocker.runtime.DefaultRockerModel {

    static public com.fizzed.rocker.ContentType getContentType() { return com.fizzed.rocker.ContentType.RAW; }
    static public String getTemplateName() { return "commandHandlerJava.rocker.raw"; }
    ...
    public commandHandlerJava project(Project project) {
    ...
    static public commandHandlerJava template(Project project) {
        return new commandHandlerJava()
            .project(project);
    }
    ...
    static public class Template extends com.fizzed.rocker.runtime.DefaultRockerTemplate {
        ...
        static {
            PlainTextUnloadedClassLoader loader = PlainTextUnloadedClassLoader.tryLoad(commandHandlerJava.class.getClassLoader(), commandHandlerJava.class.getName() + "$PlainText", "UTF-8");
        ...
        public Template(commandHandlerJava model) {
            super(model);
