...
class SendGridTest {
    ...
    void sendGridFeaturesAddsTheDependency(ProjectGenerator micronautProjectGenerator) throws Exception {
        ...
        assertTrue(verifier.hasDependency("io.micronaut.email", "micronaut-email-sendgrid"));
    }
    ...
    void sendGridFeaturesAddsTheLinkInReadmeFile(ProjectGenerator micronautProjectGenerator) throws Exception {
        ...
        assertTrue(readme.contains("https://micronaut-projects.github.io/micronaut-email/latest/guide/index.html#sendgrid"));
        assertTrue(readme.contains("https://docs.sendgrid.com/for-developers"));
