...
class MicrometerObservationHttpTest {
    @Test
    void micrometerObservationCHttpConfiguration(ProjectGenerator micronautProjectGenerator) throws Exception {
        Options options = OptionsFixture.defaultGradle().features(List.of("micrometer-observation-http")).build();
