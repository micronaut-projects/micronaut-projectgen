...
class KubernetesReactorClientTest {
    ...
    @Test
    void kubernetesReactorClientFeaturesAddsTheDiscoveryCoreDependencyForGroovyAndMaven(MicronautProjectGenerator micronautProjectGenerator) throws Exception {
