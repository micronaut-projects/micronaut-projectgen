...
class KubernetesInformerTest {
    @Test
    void kubernetesInformerFeaturesAddsTheDependency(MicronautProjectGenerator micronautProjectGenerator) throws Exception {
        MicronautOptions options = MicronautOptions.builder().feature("kubernetes-informer").build();
    ...
    @Test
    void kubernetesInformerFeaturesAddsTheDiscoveryCoreDependencyForGroovyAndMaven(MicronautProjectGenerator micronautProjectGenerator) throws Exception {
    ...
    @Test
    void kubernetesInformerFeaturesAddsTheLinkInReadmeFile(MicronautProjectGenerator micronautProjectGenerator) throws Exception {
        MicronautOptions options = MicronautOptions.builder().feature("kubernetes-informer").build();
        Map<String, String> project = generateProject(micronautProjectGenerator, options);
