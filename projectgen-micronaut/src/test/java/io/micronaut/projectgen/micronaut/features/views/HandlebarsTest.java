...
class HandlebarsTest {
    @Test
    void handlebarsViewsFeaturesAddsTheDependency(ProjectGenerator micronautProjectGenerator) throws Exception {
    ...
    @Test
    void handlebarsViewsFeaturesAddsTheLinkInReadmeFile(ProjectGenerator micronautProjectGenerator) throws Exception {
        Options options = OptionsFixture.defaultGradle().features(List.of("views-handlebars")).build();
        Map<String, String> project = generateProject(micronautProjectGenerator, options);
