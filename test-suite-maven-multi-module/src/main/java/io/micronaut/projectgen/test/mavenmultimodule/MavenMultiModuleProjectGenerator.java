...
@Singleton
public class MavenMultiModuleProjectGenerator {

    private final ProjectGenerator delegate;
    private final BeanContext beanContext;

    public MavenMultiModuleProjectGenerator(ProjectGenerator delegate,
                                            BeanContext beanContext) {
        this.delegate = delegate;
        this.beanContext = beanContext;
    }

    public void generate(@NonNull Options options, @NonNull OutputHandler outputHandler) throws Exception {
    ...
    public void generate(@NonNull Options options, @NonNull OutputHandler outputHandler, ConsoleOutput consoleOutput) throws Exception {
        Provider<AvailableFeatures> availableFeaturesProvider = provideAvailableFeatures(options);
        delegate.generate(options, outputHandler, consoleOutput, availableFeaturesProvider);
    }

    private Provider<AvailableFeatures> provideAvailableFeatures(Options options) {
        return () ->
