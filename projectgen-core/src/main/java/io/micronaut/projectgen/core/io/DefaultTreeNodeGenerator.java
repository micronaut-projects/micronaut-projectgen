...
@Singleton
class DefaultTreeNodeGenerator implements TreeNodeGenerator {
    private final PreviewGenerator previewGenerator;

    DefaultTreeNodeGenerator(PreviewGenerator previewGenerator) {
    ...
    @Override
    public TreeNode generate(Options options) throws Exception {
