 ...
 */
@Singleton
public class GradleGitIgnore implements ContributesGitIgnoreEntries {
    private static final List<String> ENTRIES = List.of("build/",
        ".gradle");

    @Override
    public GitIgnoreGroup gitIgnoreGroup(GeneratorContext generatorContext) {
        return new GitIgnoreGroup("Gradle", ENTRIES);
    }
}
