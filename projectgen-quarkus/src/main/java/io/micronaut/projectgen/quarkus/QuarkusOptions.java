...
public final class QuarkusOptions implements Options {
    ...
    private QuarkusOptions(JdkVersion javaVersion,
                           String name,
                           String packageName,
                           Language language,
    ...
    public static class Builder {
         ...
         */
        public QuarkusOptions build() {
            if (StringUtils.isEmpty(name)) {
                this.name = "code-with-quarkus";
            }
            if (StringUtils.isEmpty(packageName)) {
                this.packageName = "org.acme";
            }
            ...
            return new QuarkusOptions(javaVersion,
                name,
                packageName,
                language,
                testFramework,
