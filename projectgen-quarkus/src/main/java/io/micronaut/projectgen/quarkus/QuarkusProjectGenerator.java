...
@Singleton
public class QuarkusProjectGenerator {

    private final ProjectGenerator delegate;
    private final BeanContext beanContext;

    public QuarkusProjectGenerator(ProjectGenerator delegate,
                                   BeanContext beanContext) {
        this.delegate = delegate;
        this.beanContext = beanContext;
    }

    public void generate(@NonNull QuarkusOptions options, @NonNull OutputHandler outputHandler) throws Exception {
    ...
    public void generate(@NonNull QuarkusOptions options, @NonNull OutputHandler outputHandler, ConsoleOutput consoleOutput) throws Exception {
        Provider<AvailableFeatures> availableFeaturesProvider = provideAvailableFeatures(options);
        delegate.generate(options, outputHandler, consoleOutput, availableFeaturesProvider);
    }

    private Provider<AvailableFeatures> provideAvailableFeatures(QuarkusOptions options) {
        return () ->
